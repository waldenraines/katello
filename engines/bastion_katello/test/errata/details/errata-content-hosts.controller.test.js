...
describe('Controller: ErrataContentHostsController', function() {
    var $scope, translate, Nutupane, Erratum, ContentHostsHelper, ContentHostBulkAction,
        CurrentOrganization;
    ...
    beforeEach(inject(function($injector) {
        ...
        ContentHostsHelper = {
            ...
            getProvisioningStatusColor: function () {}
        };
    ...
    it("puts the errata content hosts table object on the scope", function() {
        ...
        expect($scope.detailsTable.getStatusColor).toBe(ContentHostsHelper.getStatusColor);
        expect($scope.detailsTable.getProvisioningStatusColor).toBe(ContentHostsHelper.getProvisioningStatusColor);
    });
