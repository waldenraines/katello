  ...
  module Service
    ...
    class RegistrationManager < RegistrationManagerTestBase
      ...
      def test_unregister_host_dead_candlepin
        ...
        ::Katello::Resources::Candlepin::Consumer.expects(:destroy).raises(RuntimeError)
      ...
      def test_unregister_host_dead_pulp
        ...
        ::Katello::Resources::Candlepin::Consumer.expects(:destroy)
        ::Runcible::Extensions::Consumer.any_instance.expects(:delete).raises(RuntimeError)
      ...
      def test_registration_dead_candlepin
        ...
        ::Katello::Resources::Candlepin::Consumer.expects(:create).with(@content_view_environment.cp_id, rhsm_params, []).raises(RuntimeError)
