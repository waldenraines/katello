...
module Katello
  class Api::V2::HostPackagesControllerTest < ActionController::TestCase
    ...
    def test_install_package
      assert_async_task ::Actions::Katello::Host::Package::Install do |system, packages|
    ...
    def test_install_group
      assert_async_task ::Actions::Katello::Host::PackageGroup::Install do |system, groups|
    ...
    def test_upgrade
      assert_async_task ::Actions::Katello::Host::Package::Update do |system, packages|
    ...
    def test_remove
      assert_async_task ::Actions::Katello::Host::Package::Remove do |system, packages|
        system.id == @system.id && packages == %w(foo)
      end
    ...
    def test_remove_group
      assert_async_task ::Actions::Katello::Host::PackageGroup::Remove do |system, groups|
        system.id == @system.id && groups == %w(blah)
      end
