...
module Katello
  class ContentViewDockerFilterTest < ActiveSupport::TestCase
    ...
    def test_repo_clause
      ...
      filter = FactoryGirl.build(:katello_content_view_docker_filter, :docker_rules => [@rule])
    ...
    def test_repo_intersection_clause
      ...
      schema_goo_repo1.docker_manifest = schema1_repo1.docker_manifest
      ...
      schema1_repo2.docker_manifest = schema1_repo1.docker_manifest
      schema2_repo2.docker_manifest = schema2_repo1.docker_manifest
      schema1_repo2.save!
      schema2_repo2.save!
